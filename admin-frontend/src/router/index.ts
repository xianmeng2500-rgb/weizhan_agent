...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'sites/select-template', name: 'SiteTemplateSelect', component: () => import('@/views/SiteTemplateSelect.vue'), meta: { title: '选择模板' } },
      ...
      { path: 'templates', name: 'SiteTemplateManage', component: () => import('@/views/SiteTemplateManage.vue'), meta: { title: '模板管理' } },
      { path: 'templates/create', name: 'SiteTemplateCreate', component: () => import('@/views/SiteTemplateEdit.vue'), meta: { title: '新建模板' } },
      { path: 'templates/edit/:id', name: 'SiteTemplateEditPage', component: () => import('@/views/SiteTemplateEdit.vue'), meta: { title: '编辑模板' } },
      ...
      { path: 'distribution', name: 'DistributionCenter', component: () => import('@/views/DistributionCenter.vue'), meta: { title: '推广中心' } },
      { path: 'admin/distribution', name: 'DistributionAdmin', component: () => import('@/views/DistributionAdmin.vue'), meta: { title: '分销管理', requiresSuperAdmin: true } },
